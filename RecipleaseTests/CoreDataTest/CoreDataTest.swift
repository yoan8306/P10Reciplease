...
class CoreDataTest: XCTestCase {
    ...
    // test if add one recipe on coreData
    ...
    // test for add three recipes on core data
    ...
    // test for delete all recipes on core data
    ...
    // test error if delete recipe when core data don't have recipe
